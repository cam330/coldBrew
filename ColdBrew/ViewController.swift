...
class ViewController: UIViewController, UNUserNotificationCenterDelegate {
    ...
    @IBAction func send10SecNotification(_ sender: UIButton) {
        ...
        if isGrantedNotificationAccess{
            ...
            let clock = Timer.scheduledTimer(timeInterval: 1.0, target: self, selector: #selector(ViewController.countdown), userInfo: nil, repeats: true)
...
//        print("BACK")
//        
////        let resumeTime = UserDefaults.standard.value(forKey: "time");
////        print("APPEAR", resumeTime ?? String())
////        
////        let currentTime = Date().timeIntervalSince1970
////        
////        let interval = ((currentTime as TimeInterval) - (resumeTime as! TimeInterval))
////        
////        print(interval)
//        
//    }
